...
export const answer = (res: Response, statusCode: StatusCode, data: unknown) => {
...
export const answerSuccessOk = (res: Response, data: unknown = null) => {
  answer(res, StatusCode.SuccessOK, data ?? "OK");
};

export const answerSuccessCreated = (res: Response, data: unknown = null) => {
